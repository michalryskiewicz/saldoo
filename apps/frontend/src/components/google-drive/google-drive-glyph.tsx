...
/**
 * The Drive mark itself.
 *
 * Kept as the app's own SVG rather than a generic cloud, because the point of this icon is to say
 * *what* the data is synced with. `currentColor` throughout, so whatever renders it decides the
 * state colour.
 */
